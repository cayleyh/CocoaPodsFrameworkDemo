...
typedef NS_ENUM(NSUInteger, LMGSessionAuthStatus) {
    LMGSessionAuthStatusUnknown,
    LMGSessionAuthStatusAnonymous,
    LMGSessionAuthStatusIdentified,
    LMGSessionAuthStatusVerified
};
...
/**
 * Returns the session current authentication status
 */
- (LMGSessionAuthStatus)getAuthStatus;
