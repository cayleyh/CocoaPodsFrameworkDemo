...
- (nonnull id<LMGDAOfferStore>)storeForParams:(nonnull LMGDetailsRequestParams *)params refresh:(BOOL)shouldRefresh;
- (nonnull id<LMGDAOfferStore>)storeForListParams:(nonnull LMGOffersListRequestParams *)params refresh:(BOOL)shouldRefresh;
