...
@interface LMGBusiness : NSObject <NSCopying, LMGDeepCopying>
...
- (nonnull instancetype)initWithId:(nonnull LMGPlatformId *)businessId name:(nullable NSString *)name shortName:(nonnull NSString *)shortName NS_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWith:(nonnull LMGBusiness *)business;
- (nonnull instancetype)init NS_UNAVAILABLE;

- (nonnull LMGBusiness *)build;
