...
@property (nonnull, nonatomic, copy, readonly) LMGPlatformId *businessId;
@property (nonnull, nonatomic, copy, readonly) LMGPlatformId *locationId;

- (nonnull instancetype)initWithState:(nonnull LMGRedemptionState *)state
                              offerId:(nonnull LMGPlatformId *)offerId
                              businessId:(nonnull LMGPlatformId *)businessId
                           locationId:(nonnull LMGPlatformId *)locationId transition:(nonnull LMGRedemptionStateTransition *)transition
                                 args:(nonnull NSArray<LMGRedemptionTransitionArgument *> *)args NS_DESIGNATED_INITIALIZER;
