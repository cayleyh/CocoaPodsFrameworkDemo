...
@interface LMGOffer : NSObject <NSCopying, LMGDeepCopying>
...
@property (nullable, nonatomic, copy, readonly) LMGOfferStateMeta *stateMeta;
...
@property (nullable, nonatomic, copy) LMGOfferStateMeta *stateMeta;
